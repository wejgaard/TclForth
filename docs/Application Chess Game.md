Here is a little chess game TclForth. - The program is adapted from the original [Chess in Tcl](http://wiki.tcl.tk/4070) and also serves to compare Tcl and Forth source. Note the absence of block markers, statement delimiters and command substitutions.
